    ...
    <>
      ...
      <SignedIn>
        <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-dark-2">
          <header className="absolute z-50 top-0 left-0 w-full py-4 px-8 flex justify-between items-center">
            <h1 className="text-2xl font-bold text-white">Flohub</h1>
            <UserButton afterSignOutUrl="/" />
          </header>

          <div className="flex flex-col items-center gap-8">
            <h1 className="text-4xl font-bold">Video Chat Room</h1>
